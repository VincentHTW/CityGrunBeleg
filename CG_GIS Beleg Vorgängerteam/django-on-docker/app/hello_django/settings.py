...
SECRET_KEY = "citygruen2keyi2se6ure"
...
INSTALLED_APPS = [
    ...
    'citygruen.apps.CitygruenConfig'
]
...
# https://docs.djangoproject.com/en/3.2/ref/settings/#databases
        ...
        #"NAME": str(os.environ.get("SQL_DATABASE", BASE_DIR / "db.postgresql")),
        

DATABASES = {
    "default": {
        "ENGINE": os.environ.get("SQL_ENGINE", "django.db.backends.postgresql"),
        "NAME": str(os.environ.get("SQL_DATABASE", "hello_django_dev")),
...
LOGIN_REDIRECT_URL = '/aktive_routen/'